	...
	layui.use([ 'table', 'layer' ], function() {
		...
		table.render({
					...
					cols : [[  
	                    ...
	                    { field : 'scysxm', title : '筛查医生姓名', width : '160' } ,
	                    { field : 'scrq', title : '筛查日期', width : '150' } ,
	                    { field : 'scjg', title : '筛查结果', width : '150' }
...
function getechatsdata(startdate,enddate,nllx,yljgdm){
    ...
    $.ajax({
      url: "${ctx}/LnrNczXz/LnrNczXz.json?p_startdate="+startdate+"&p_enddate="+enddate+"&p_yljgdm="+yljgdm,
       datatype:"json",
      ...
      success: function(data){
         ...
         var fianl=xx.LnrNczXzList;
          
         var nczrs=new Array();
         var nczlxmc =new Array();  
         ...
         for (var i=0;i<fianl.length;i++)
               {   
        	 nczrs[i]=fianl[i].nczrs; 
        	 nczlxmc[i]=fianl[i].nczlxmc; 
        	 yljgdm[i]=fianl[i].yljgdm;
        	 yljgmc[i]=fianl[i].yljgmc; 
        	 nczzb[i]=fianl[i].nczzb; 
               }
           
           chart01('map',nczrs,nczlxmc,yljgdm,yljgmc,nczzb,startdate,enddate);
        }
        });
