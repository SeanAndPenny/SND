...
function chart01(id,rs,ksbm,ksmc,yljgdm,kssj,jssj){
...
function search(yljgdm,ksbm,kssj,jssj){
  layui.use([ 'table', 'layer' ], function() {
    var table = layui.table;
    table.render({
          elem : '#querytable',
          url : '${ctx}/bass/jtysJgXzysXx',
          toolbar : '#toolbarDemo',
          method : 'post',
          where : { 
            p_yljgdm : yljgdm,
          ...
          cols : [[  
        	  { field : 'ksmc', title : '科室名称', width : '500' }, 
...
function getechatsdata(kssj,jssj,jgdm){
    ...
    $.ajax({
      url: "${ctx}/bass/bassKsxz.json?p_kssj="+kssj+"&p_jssj="+jssj+"&p_jgdm="+jgdm,
       datatype:"json",
      ...
      success: function(data){
        ...
        var yljgdm=new Array();
         ...
         for (var i=0;i<fianl.length;i++) {   
           ...
           chart01('map',rs,ksbm,ksmc,yljgdm,kssj,jssj);
