...
function jcfxEchars(jgdm){
      ...
      $.ajax({
        url: "${ctx}/jyfx/jyfx.json?p_kssj="+kssj
              +"&p_jssj="+jssj
              +"&p_jgdm="+jgdm,    
         datatype:"json",
        ...
        success: function(data){
           ...
           var fianl=xx.jyfxList;
           var yljgmc=new Array();
           var yljgdm=new Array();
           var jyrs=new Array();
           var yylb=new Array();
           
           var fian2=xx.jyjcfxList;
           ...
           for (var i=0;i<fian2.length;i++) { 
        	   ...
        	   jyrs2[i]=fian2[i].jyrs; 
        	   yylb2[i]=fian2[i].yylb; 
              }
            
           chart01('chart01',yljgmc,yljgdm,jyrs,kssj,jssj,yylb); 
           chart02('chart02',yljgmc2,yljgdm2,jyrs2,kssj,jssj,yylb2);     
          }
          });
...
function chart01(id,yljgmc,yljgdm,jyrs,kssj,jssj,yylb) { 
...
function chart02(id,yljgmc,yljgdm,jyrs,kssj,jssj,yylb) { 
...
function getechars(yljgdm,kssj,jssj,yylb,yljgmc){
	 $.ajax({
	      url: "${ctx}/jyfx/getechars.json?p_kssj="+kssj
	            +"&p_jssj="+jssj
	            +"&p_jgdm="+yljgdm
	            +"&p_yylb="+yylb,    
	       datatype:"json",
			...
			<div class="topLeft">
				<span class="det"> <span class="sj sjKs">
					...
					for="">机构名称</label> <select  style="width: 165px;" id="jgdm" name="jgdm" lay-search>
						...
						<c:forEach items="${jyjgList}" var="jg">
