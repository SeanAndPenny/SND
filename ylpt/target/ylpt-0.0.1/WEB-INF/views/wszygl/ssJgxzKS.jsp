...
function chart01(id,yljgdm,yljgmc,ksbm,ksmc,month){
	...
	var option = {
	  ...
	  window.open("${ctx}/ssJbxzKsRy/ssJbxzKsRy?p_yljgdm="+yljgdm[param.dataIndex]
	 +"&p_ksbm="+ksbm[param.dataIndex]);  
	 
	});
}

function getechatsdata(yljgdm ){
	 
    $.ajax({
    	url: "${ctx}/ssJgxzKS/ssJgxzKSecharts.json?p_yljgdm="+yljgdm,
    	 datatype:"json",
    	...
    	success: function(data){
    		 ...
    		 var fianl=xx.ssJgxzKSechartsechartsList;
         	...
         	chart01('map',yljgdm,yljgmc,ksbm,ksmc,month);
    		}
      	});
