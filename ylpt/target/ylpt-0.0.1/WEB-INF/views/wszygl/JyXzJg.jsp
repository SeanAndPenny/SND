...
function chart01(id,yljgdm,yljgmc,sfws,month){
  ...
  var option = {
   ...
   window.open("${ctx}/JyXzKs/JyXzKs?p_sfws="+sfws[0]+"&p_yljgdm="+yljgdm[param.dataIndex]); 
  });
}
...
function getechatsdata(sfws  ){
    ...
    $.ajax({
      url: "${ctx}/JyXzJg/JyXzJgecharts.json?p_sfws="+sfws,
       datatype:"json",
      ...
      success: function(data){
         ...
         var fianl=xx.JyXzJgechartslist;
