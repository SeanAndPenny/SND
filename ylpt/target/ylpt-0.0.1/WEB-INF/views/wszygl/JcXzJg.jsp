...
function chart01(id,yljgdm,yljgmc,sfws,month){
  ...
  var option = {
   ...
   window.open("${ctx}/JcXzKs/JcXzKs?p_sfws="+sfws[0]+"&p_yljgdm="+yljgdm[param.dataIndex]); 
  });
}

function getechatsdata(sfws){
  
    $.ajax({
      url: "${ctx}/JcXzJg/JcXzJgecharts.json?p_sfws="+sfws,
       datatype:"json",
      ...
      success: function(data){
         ...
         var fianl=xx.JcXzJgechartslist;
         ...
         for (var i=0;i<fianl.length;i++)
           ...
           chart01('map',yljgdm,yljgmc,sfws,month);
        }
        });
