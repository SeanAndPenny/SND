...
function chart01(id,ryks,month){
...
function getechatsdata(yljgdm,rq){
    ...
    $.ajax({
    	url: "${ctx}/ssywjcKs/ssywjcKsecharts.json?p_yljgdm="+yljgdm+"&p_rq="+rq,
    	 datatype:"json",
    	...
    	success: function(data){
    		...
    		var hh= JSON.stringify(nodes);
    		 ...
    		 var fianl=xx.ssywjcKsechartsList;
...
function getData(){
        layui.use(['table','layer','laydate'] , function(){
            ...
            table.render({
                ...
                cols: [[
                	{field: 'yljgmc', title: '机构名称', width: '280'},
                    {field: 'ryks', title: '入院科室', width: '280'},
                    {field: 'rysj', title: '入院时间', width: '280'},
                    {field: 'xm', title: '姓名', width: '280'},
                    {field: 'xb', title: '性别', width: '280'}
                  ]],
                height: '400',
