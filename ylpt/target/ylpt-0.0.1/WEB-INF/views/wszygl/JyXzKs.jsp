...
function chart01(id,yljgdm,sfws,sqks,sqksmc,month){
  ...
  var option = {
   ...
   window.open("${ctx}/JyXzYs/JyXzYs?p_sfws="+sfws[0]+"&p_yljgdm="+yljgdm[param.dataIndex]+"&p_sqks="+sqks[param.dataIndex]); 
  });
}
...
function getechatsdata(sfws,yljgdm  ){
    ...
    $.ajax({
      url: "${ctx}/JyXzKs/JyXzKsecharts.json?p_sfws="+sfws+"&p_yljgdm="+yljgdm,
       datatype:"json",
      ...
      success: function(data){
         ...
         var fianl=xx.JJyXzKsechartslist;
