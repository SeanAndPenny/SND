...
function getechatsdata(yljgdm,startdate,enddate){
    $.ajax({
    	url: "${ctx}/zytz/zytzbsecharts.json?p_yljgdm="+yljgdm+"&p_startdate="+startdate+"&p_enddate="+enddate,
    	 datatype:"json",
...
function getData(){
        layui.use(['table','layer','laydate'] , function(){
            ...
            table.render({
                ...
                cols: [[
                    ...
                    {field: 'tz', title: '体质', width: '150'},
                    {field: 'jcsj', title: '检查时间', width: '120'},
                    {field: 'doctor', title: '检查医生', width: '100'},
        ...
        //监听工具条
            table.on('tool(querytab)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
				...
				if (layEvent === 'detail') {
					 window.open("http://172.26.201.24/zytzWeb/index.swf?uDabh="+data.wjbh)
