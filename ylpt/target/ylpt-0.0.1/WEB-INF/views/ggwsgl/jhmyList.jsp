...
function getechatsdata(yljgdm,startdate,enddate){
    $.ajax({
    	url: "${ctx}/jhmy/jhmyecharts.json?p_yljgdm="+yljgdm+"&p_startdate="+startdate+"&p_enddate="+enddate,
    	 datatype:"json",
...
function getData(){
        layui.use(['table','layer','laydate'] , function(){
            ...
            table.render({
                ...
                url: '${ctx}/jhmy/jhmy',
                method:'post',
                where:{p_yljgdm:$("#yljgdm").val(),p_startdate:$("#startdate").val(),p_enddate:$("#enddate").val(),p_mid:$("#mid").val()},          
                cols: [[
                	{field: 'jgmc', title: '接种单位', width: '150'},
                    {field: 'name', title: '姓名', width: '80'},
                    {field: 'sex', title: '性别', width: '70'},
                    {field: 'birth', title: '出生日期', width: '110'},
                    {field: 'mname', title: '母亲姓名', width: '90'},
                    {field: 'mid', title: '母亲身份证号', width: '180'},
                    {field: 'phone', title: '联系电话', width: '120'},
                    {field: 'jzsj', title: '接种时间', width: '110'},
                    {field: 'fy', title: '副反应名称', width: '100'},
                    {field: 'fysj', title: '副反应发生时间', width: '130'},
                    {field: 'ym', title: '接种疫苗', width: '100'},
                    {field: 'cj', title: '制药厂家', width: '100'}
	...
	<div id="queryform" class="layui-form" style="background: #FFFFFF">
		<table style="width: 100%">
			<tr>
				...
				<td style="width: 33.3%" >
					<div class="layui-form-item" style="margin-top: 20px;">
						<label class="layui-form-label label3">母亲身份证号</label>
						<div class="layui-input-inline input3"> 
						<input type="text" id="mid" name="mid" autocomplete="off"
								class="layui-input .input2">
						</div>
					</div>
				</td>
