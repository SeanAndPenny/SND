					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="thumbnail no-margin-bottom">
								<img
									src="static/commons/images/thumbnails/picjumbo.com_IMG_4566.jpg"
									class="img-responsive">
								<div class="caption">
									<h3 id="thumbnail-label">
										Thumbnail label<a class="anchorjs-link"
						...
						<div class="col-md-6 col-sm-12">
							<div class="thumbnail no-margin-bottom">
								<img
									src="static/commons/images/thumbnails/picjumbo.com_IMG_3241.jpg"
									class="img-responsive">
								<div class="caption">
									<h3 id="thumbnail-label">
										Thumbnail label<a class="anchorjs-link"
									...
									<p>Cras justo odio, dapibus ac facilisis in, egestas eget
										...
										id dolor id nibh ultricies vehicula ut id elit.</p>
									<p>
										<a href="#" class="btn btn-success" role="button">Button</a> <a
											href="#" class="btn btn-default" role="button">Button</a>
									</p>
								</div>
							</div>
					...
					<div class="card card-success">
						...
						<div class="card-body no-padding">
							<ul class="message-list">
								<a href="#">
									<li><img src="static/commons/images/profile/profile-1.jpg"
