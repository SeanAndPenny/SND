...
function chart01(id,moth,rs,ypzl){
...
function getechatsdata(yljgdm,startdate,enddate){
    $.ajax({
    	url: "${ctx}/yfjz/jztjecharts.json?p_yljgdm="+yljgdm+"&p_startdate="+startdate+"&p_enddate="+enddate,
    	 datatype:"json",
...
function getData(){
        layui.use(['table','layer','laydate'] , function(){
            ...
            table.render({
                ...
                cols: [[
                	{field: 'jgmc', title: '接种单位', width: '300'},
                    {field: 'jzrs', title: '接种人数', width: '300'},
                    {field: 'jzrc', title: '接种次数', width: '300'},
                    {field: 'ypzl', title: '接种药品种类', width: '300'},
