...
function getechatsdata(yljgdm,startdate,enddate){
    $.ajax({
    	url: "${ctx}/jyqy/jyqyecharts.json?p_yljgdm="+yljgdm+"&p_startdate="+startdate+"&p_enddate="+enddate,
    	 datatype:"json",
...
function getData(){
        layui.use(['table','layer','laydate'] , function(){
            ...
            table.render({
                ...
                cols: [[
                	{field: 'chargehospital', title: '机构名称', width: '240'},
                    {field: 'name', title: '姓名', width: '100'},
                    {field: 'idno', title: '身份证号', width: '190'},
                    {field: 'address', title: '家庭地址', width: '190'},
                    {field: 'phone', title: '联系电话', width: '150'},
                    {field: 'signtime', title: '签约时间', width: '120'},
                    {field: 'adddoctor', title: '签约医生', width: '100'},
                    {field: 'chargeteam', title: '签约团队', width: '135'},                    
