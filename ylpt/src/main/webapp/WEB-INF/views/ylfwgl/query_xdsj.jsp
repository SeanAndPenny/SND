...
function getData(){
        layui.use(['table','layer','laydate'] , function(){
            ...
            table.render({
                elem:'#querytable',
                url: '${ctx}/xdsj/queryXdsj',
                method:'post',
                where:{p_yljgdm:$("#yljgdm").val(),p_startdate:$("#startdate").val(),p_enddate:$("#enddate").val()},          
                cols: [[
                    {field: 'jgmc', title: '机构名称', width: '300'},
                    {field: 'hzxm', title: '患者姓名', width: '150'},
                    {field: 'kh', title: '卡号', width: '150'},
                    {field: 'ksmc', title: '科室名称', width: '150'},
                    {field: 'jcbw', title: '检查部位', width: '150'},
                    {field: 'jcffmc', title: '检查方法名称', width: '150'},
                    {field: 'sj', title: '开单时间', width: '200'},
                    {field: 'jcjllsh', title: '操作',fixed: 'right', toolbar: '#toolbar'}
                     ]],
                height: '400',
                width:'auto',
                page: {
