...
function chart01(id,jgmc,month,jgdm,lx,rq){
	...
	var option = {
	  ...
	  myChart.on('click', function(param) { 
		  window.open("${ctx}/ssywjcMzKs/ssywjcMzKs?p_yljgdm="+jgdm[param.dataIndex]
...
function getechatsdata(rq){
    ...
    $.ajax({
    	url: "${ctx}/ssywjcMzrsXz/ssywjcMzrsXzecharts.json?p_rq="+rq,
    	 datatype:"json",
    	...
    	success: function(data){
    		...
    		var hh= JSON.stringify(nodes);
    		 ...
    		 var fianl=xx.ssywjcMzrsXzechartsList; 
    		 var jgmc=new Array();
    		 var month=new Array();
         	 var jgdm =new Array();
         	 var lx =new Array();
...
function getData(){
        layui.use(['table','layer','laydate'] , function(){
            ...
            table.render({
                elem:'#querytable',
                url: '${ctx}/ssywjcMzrsXz/ssywjcMzrsXz',
                method:'post',
                where:{
                	p_rq : '${rq}',
