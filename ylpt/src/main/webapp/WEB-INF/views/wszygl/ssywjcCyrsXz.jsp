...
function chart01(id,jgmc,month,jgdm,lx,rq){
	...
	var option = {
	  ...
	  myChart.on('click', function(param) { 
		  window.open("${ctx}/ssywjcCyKs/ssywjcCyKs?p_yljgdm="+jgdm[param.dataIndex]
...
function getechatsdata(rq){
    ...
    $.ajax({
    	url: "${ctx}/ssywjcCyrsXz/ssywjcCyrsXzecharts.json?p_rq="+rq,
    	 datatype:"json",
    	...
    	success: function(data){
    		...
    		var hh= JSON.stringify(nodes);
    		 ...
    		 var fianl=xx.ssywjcCyrsXzechartsList; 
    		 var jgmc=new Array();
    		 var month=new Array();
         	 var jgdm =new Array();
         	 var lx =new Array();
...
function getData(){
        layui.use(['table','layer','laydate'] , function(){
            ...
            table.render({
                elem:'#querytable',
                url: '${ctx}/ssywjcCyrsXz/ssywjcCyrsXz',
                method:'post',
                where:{
                	p_rq : '${rq}',
                ...
                cols: [[/* 
                    ...
                    {field: 'cyks', title: '出院科室', width: '240'},
                    {field: 'cysj', title: '出院时间', width: '240'},
