...
function chart01(id,nlrs,nllx,yljgdm,yljgmc,startdate,enddate){
  ...
  var option = {
   ...
   search(  
		   startdate,enddate,nllx[param.dataIndex],yljgdm[param.dataIndex])
  });
}
function search(startdate,enddate,nllx,yljgdm){ 
	layui.use([ 'table', 'layer' ], function() {
		var table = layui.table;
		table.render({
					elem : '#querytable',
					url : '${ctx}/gxyNlXz/gxyNlXzXx',
					toolbar : '#toolbarDemo',
					method : 'post',
					where : { 
...
function getechatsdata(startdate,enddate,nllx,yljgdm){
    ...
    $.ajax({
      url: "${ctx}/gxyNlXz/gxyNlXz.json?p_startdate="+startdate+"&p_enddate="+enddate+"&p_nllx="+nllx+"&p_yljgdm="+yljgdm,
       datatype:"json",
      ...
      success: function(data){
         ...
         for (var i=0;i<fianl.length;i++)
           ...
           chart01('map',nlrs,nllx,yljgdm,yljgmc,startdate,enddate);
        }
        });
...
function getData(){                   
   ...
   var nllx='${nllx}'; 
   var yljgdm='${yljgdm}';
    getechatsdata(startdate,enddate,nllx,yljgdm);        
 }
