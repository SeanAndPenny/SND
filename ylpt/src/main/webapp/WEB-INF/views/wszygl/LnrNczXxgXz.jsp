...
function chart01(id,gtrs,gtmc,yljgdm,yljgmc,gtzb,startdate,enddate){
...
function search(startdate,enddate,yljgdm){ 
	layui.use([ 'table', 'layer' ], function() {
		...
		table.render({
					elem : '#querytable',
					url : '${ctx}/LnrNczXxgXz/LnrNczXzXx',
					toolbar : '#toolbarDemo',
					method : 'post',
					where : { 
...
function getechatsdata(startdate,enddate,nllx,yljgdm){
    ...
    $.ajax({
      url: "${ctx}/LnrNczXxgXz/LnrNczXxgXz.json?p_startdate="+startdate+"&p_enddate="+enddate+"&p_yljgdm="+yljgdm,
       datatype:"json",
      ...
      success: function(data){
         ...
         for (var i=0;i<fianl.length;i++)
           ...
           chart01('map',gtrs,gtmc,yljgdm,yljgmc,gtzb,startdate,enddate);
        }
        });
