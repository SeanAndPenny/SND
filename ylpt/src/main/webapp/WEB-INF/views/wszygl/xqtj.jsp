...
<script type="text/javascript"
	src="<c:url value="/static/commons/js/newApp.js"/>"></script>

<script type="text/javascript"
	src="<c:url value="/static/commons/js/jquery-1.11.1.min.js"/>"></script>

<script type="text/javascript"
	src="<c:url value="/static/commons/js/jquerysession.js"/>"></script>
...
function chart02(id) {
  ...
  var ZrsList =<%=request.getAttribute("ZrsList")%>;
    ...
    function chart07(id) {
      var JcsfwsList =<%=request.getAttribute("JcsfwsList")%>;
      var myChart = echarts.init(document.getElementById(id));
        myChart.dispose();
        myChart = echarts.init(document.getElementById(id));
        var option = {
            ...
            series: [
                {
                    ...
                    data: [ 
                      <c:forEach var="jcList" items="${jcList}">
                        {
                          name  :"${jcList.lbmc}",value:"${jcList.rs}"
                        },
                        </c:forEach> 
                    ]
                }
      ...
      myChart.on('click', function(param) { 
        ...
        window.open("${ctx}/JcXzJg/JcXzJg?p_sfws="+JcsfwsList[param.dataIndex]);
      });
    };
	...
	<div class="page-shouye">
      ...
      <img src="images/head-right.png" alt="" class="head-right"> -->
			<div class="title">
				...
				<span>卫生数据资源可视化平台</span>
			</div>
			<div class="bot-box">
				<ul id="top-tab">
					<li class="active" onclick="window.location.href='/ylpt/xqtj/xqtj'">首页</li>
					<li onclick="qyzy('http://10.10.100.120:8080/zhjg_cd/newindex.action?resId=f6675db128474718ab83daf76ce211d4')">区域资源</li>
					<li
						onclick="qyzy('http://10.10.100.120:8080/zhjg_cd/newindex.action?resId=f6675db128474718ab83daf76ce211d4')">医疗服务</li>

					 
					<li
						onclick="qyzy('http://10.10.100.120:8080/zhjg_cd/newindex.action?resId=d3925597575f4edfa3bc0c756efb0587')">公共卫生</li>
					<li
						onclick="qyzy('http://10.10.100.120:8080/zhjg_cd/newindex.action?resId=98bf45df3e524f9fbfeb3ff2bc845209')">家庭医生</li>
					 
					
					<li
						onclick="qyzy('http://10.10.100.120:8080/zhjg_cd/newindex.action?resId=71b3ba722b064f30bddd0bd9f73b6166')">主题报表</li>
					 

				</ul>
				<div class="user">
					<span><%=request.getAttribute("name")%>,您好</span> <span><a
						style="color: #ff0000;" href="Javascript:exit()">[退出系统]</a></span>
				</div>
		...
		<div class="main">
			<ul class="wd-g">
					...
					<div class="itembg">
						<div class="mode-top">
							...
							<div class="time-choose">
								<span class="start-time">注册开始时间</span> <span class="input-box">
									<input type="text" id="startdate" readonly="readonly"
									onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"
									value='${startdate }' class="start-input" style="width: 100px" />
									<img
									src="<c:url value="/static/commons/images/date-icon.png"/>">
								</span> <span class="end-time">注册结束时间</span> <span class="input-box">
									<!-- <input type="text" class="end-input" placeholder="2019-09" id="test2"> -->
									<input type="text" id="enddate" readonly="readonly"
									onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"
									value='${enddate }' class="end-input" style="width: 100px" />
									<img
									src="<c:url value="/static/commons/images/date-icon.png"/>">
								</span>
						...
						<div class="mode-main">
							<div class="subtitle">
								<img
									src="<c:url value="/static/commons/images/subtitle01.png"/>">
								<span id="searchyy"><%=request.getAttribute("mc")%>医院</span> <span
									class="num1"><%=request.getAttribute("xsnr")%></span> <span>家，占比</span>
								<span class="num2"><%=request.getAttribute("xsnr2")%></span> <span>%</span>
							</div>
							<ul>
								<li class="left-part">
									<div class="echarts-box">
										<span class="planer-name"> <span class="icon"></span> <span
											class="name">医疗机构占比分布</span> <span class="icon"></span>
										</span>
								...
								<li class="right-part">
									<div class="echarts-box">
										<span class="planer-name"> <span class="icon"></span> <span
											class="name">人员类型分析</span> <span class="icon"></span>
										</span>
				...
				<li class="mode wd-u-1-4 mode02">
					<div class="itembg">
						<div class="mode-title">
							<span class="icon"></span> <span>出生人数统计(本年)</span>
						</div>
						<div class="select-box">
						...
						<div class="mode-main">
							<div class="subtitle">
								<img
									src="<c:url value="/static/commons/images/subtitle02.png"/>">
								<!-- <img src="images/subtitle02.png" alt=""> -->
								<span>全区本年度出生人数</span> <span id="csrs" class="num1"><%=request.getAttribute("csrstj")%></span>
								<span>人</span>
							</div>
							<div class="echarts-box">
				...
				<li class="mode wd-u-3-8 mode03">
					<div class="itembg">
						<div class="mode-title">
							<span class="icon"></span> <span>急救资源统计(当月)</span>
						</div>
						<div class="mode-main">
							<div class="subtitle">
								<img
									src="<c:url value="/static/commons/images/subtitle03.png"/>">
								<!-- <img src="images/subtitle03.png" alt=""> -->
								<span>全区应急车辆</span> <span class="num1"><%=request.getAttribute("yjcl")%></span>
								<span>辆</span>
							</div>
							<div class="table-box">
				...
				<li class="mode wd-u-5-8 mode04">
					<div class="itembg">
						<div class="mode-title">
							<span class="icon"></span> <span>区域床位统计(当天)</span>
						</div>
						<div class="mode-main">
							<div class="left-part">
								<div class="subtitle">
									<span class="icon"></span> <span>资源数据统计</span>
								</div>
								<div class="table-box">
									<div class="view">
										<table class="table-data">
							...
							<div class="echarts-box">
								<span class="planer-name"> <span class="icon"></span> <span
									class="name">床位统计</span> <span class="icon"></span>
								</span>
				...
				<li class="mode wd-u-3-8 mode05">
					<div class="itembg">
						<div class="mode-title">
							<span class="icon"></span> <span>家庭医生签约(当月)</span>
						</div>
						<div class="select-box">
						...
						<div class="mode-main">
							<div class="subtitle">
								...
								<span>全区本月度签约人数</span> <span class="num1"><%=request.getAttribute("jtystj")%></span>
								<span>人</span>
							</div>
							<div class="echarts-box">
								<span class="planer-name"> <span class="icon"></span> <span
									id="jtysqy" class="name">签约机构占比</span> <span class="icon"></span>
								</span>
				...
				<li class="mode wd-u-5-16 mode06">
					<div class="itembg">
						<div class="mode-title">
							<span class="icon"></span> <span>外送检验样本量(本年)</span>
						</div>
						<div class="mode-main" style="margin-top: 8px;">
							<div class="echarts-box">
								<div
									style="position: absolute; margin-top: 110px; margin-left: 166px;">
									<img
										src="<c:url value="/static/commons/images/mode06-icon.png"/>">
								</div>
				...
				<li class="mode wd-u-5-16 mode07">
					<div class="itembg">
						<div class="mode-title">
							<span class="icon"></span> <span>远程影像诊断量(本年)</span>
						</div>
						<div class="mode-main" style="margin-top: 8px;">
							<div class="echarts-box">
								<div
									style="position: absolute; margin-top: 110px; margin-left: 166px;">
									<img
										src="<c:url value="/static/commons/images/mode07-icon.png"/>">
								</div>
				...
				<li class="mode wd-u-1-1 mode08">
					<div class="itembg">
						<div class="mode-title">
							<span class="icon"></span> <span>实时业务监测</span>
						</div>

						<div class="time-choose">
							<span class="start-time">开始时间</span> <span class="input-box">
								<input type="text" id="ywkssj" readonly="readonly"
								onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value='${ywkssj }'
								class="start-input" style="width: 100px" /> <img
								src="<c:url value="/static/commons/images/date-icon.png"/>">
							</span> <span class="end-time">结束时间</span> <span class="input-box">
								<!-- <input type="text" class="end-input" placeholder="2019-09" id="test2"> -->
								<input type="text" id="ywjssj" readonly="readonly"
								onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value='${ywjssj }'
								class="end-input" style="width: 100px" /> <img
								src="<c:url value="/static/commons/images/date-icon.png"/>">
							</span>
                  ...
                  <span class="icon"></span>
									...
									<div>
										<ul>
											<li onclick="getData1('A1')"><span class="planer-name">
													<span class="icon"></span> <span class="name">综合医院</span> <span
													class="icon"></span></li>
											<li class="layui-this" onclick="getData1('AA')"
												style="margin-top: -42px; margin-left: 113px;"><span
												class="planer-name"> <span class="icon"></span> <span
													class="name">基层医院</span> <span class="icon"></span></li>
										</ul>
									</div>
								</div>
							...
							<div class="echarts-box">
								<span class="planer-name"> <span class="icon"></span> <span
									class="name">实时人次分析</span> <span class="icon"></span>
								</span>
				...
				<li class="mode wd-u-6-16 mode09">
					<div class="itembg">
						<div class="mode-title">
							<span class="icon"></span> <span>住院病案手术查询</span>
						</div>
						<ul class="time-choose clearfix">
							<li>
								<div class="start-time">开始时间</div>
								<div class="input-box">
									<input type="text" id="basskssj" readonly="readonly"
										onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"
										value='${basskssj }' class="start-input" style="width: 100px" />
									<img
										src="<c:url value="/static/commons/images/date-icon.png"/>"
										alt="" id="date5">
							...
							<li>
								...
								<div class="input-box">
									<input type="text" id="bassjssj" readonly="readonly"
										onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"
										value='${bassjssj }' class="start-input" style="width: 100px" />
									<img
										src="<c:url value="/static/commons/images/date-icon.png"/>"
										alt="" id="date6">
							...
							<li>
								<div class="end-time">机构名称</div> <select id="bassjgdm"
								name="bassjgdm" lay-search>
						...
						<div class="mode-main">
							<span class="planer-name"> <span class="icon"></span> <span
								class="name">住院疾病手术人次TOP15</span> <span class="icon"></span>
							</span>
							<div class="echarts-box">
				...
				<li class="mode wd-u-6-16 mode10">
					<div class="itembg">
						<div class="mode-title">
							<span class="icon"></span> <span>住院病案病种查询</span>
						</div>
						<ul class="time-choose clearfix">
							<li>
								<div class="start-time">开始时间</div>
								<div class="input-box">
									<input type="text" id="basystartDate" readonly="readonly"
							...
							<li>
								<div class="end-time">结束时间</div>
								<div class="input-box">
									<input type="text" id="basyendDate" readonly="readonly"
							...
							<li>
								<div class="end-time">机构名称</div> <select id="bajgdm"
								name="bajgdm" lay-search>
									<option value="">医疗机构</option>
									<c:forEach items="${bajgList}" var="jg">
										<option value="${jg.jgdm}">${jg.jgmc}</option>
									</c:forEach>
						...
						<div class="mode-main">
							<span class="planer-name"> <span class="icon"></span> <span
								class="name">住院疾病发病人次TOP15</span> <span class="icon"></span>
							</span>
							<div class="echarts-box">
				...
				<li class="mode wd-u-1-4 mode11">
					<div class="itembg">
						<div class="mode-title">
							<span class="icon"></span> <span>区域手术汇总(月)</span>
						</div>
						<div class="select-box">
						...
						<div class="mode-main">
							<div class="subtitle">
								<img
									src="<c:url value="/static/commons/images/subtitle10.png"/>"
									alt="">
								<!-- <img src="images/subtitle10.png" alt=""> -->
								<span>手术总量</span> <span class="num1"><%=request.getAttribute("sstj")%></span>
								<span>台</span>
							</div>
							<div class="echarts-box">
					...
					<div class="itembg itembg-bot">
						<div class="mode-title">
							<span class="icon"></span> <span>全区建档</span>
						</div>
						<div class="mode-main">
							<div class="subtitle">
								<img
									src="<c:url value="/static/commons/images/subtitle11.png"/>"
									alt="">
								<!-- <img src="images/subtitle11.png" alt=""> -->
								<span>全区建档人数</span> <span class="num1"><%=request.getAttribute("jdtjrs")%></span>
								<span>人</span>
							</div>
							<div class="echarts-box">
