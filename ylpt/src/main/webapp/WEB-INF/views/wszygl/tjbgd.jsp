		...
		<DIV
			...
			<DIV
				...
				<SPAN id=Panel1 class=xstyle_69_1> <!-- <DIV id=Label1 class=xstyle_69_2>南京市第二医院</DIV> -->
					<DIV id=Label2 class=xstyle_69_3>&nbsp;&nbsp;体检报告单</DIV>
					<div class="T_title T_bg">
						<p align="right" class="pT10">
							体检编号：
							 <span class="blueColor">${jyrxx.tjbh } </span>
						...
						<TBODY>
							...
							<TR style="HEIGHT: 25px">
								<TD class=xstyle_69_5 style="width: 5px;"><SPAN
									class=xstyle_69_6>体检机构：</SPAN></TD>
								<TD class=xstyle_69_7 style="width: 15px;"><SPAN
									class=xstyle_69_8> ${jyrxx.yljgmc }  </SPAN></TD>
								<TD class=xstyle_69_9 style="width: 10px;"><SPAN
									class=xstyle_69_10>姓名：</SPAN></TD>
								<TD class=xstyle_69_7 style="width: 10px;"><SPAN
									class=xstyle_69_8>${jyrxx.xm } </SPAN></TD>
								<TD class=xstyle_69_9 style="width: 10px;"><SPAN
									class=xstyle_69_10>性别：</SPAN></TD>
								<TD class=xstyle_69_7 style="width: 10px;"><SPAN
									class=xstyle_69_8> ${jyrxx.xb } </SPAN></TD>
								<TD class=xstyle_69_9 style="width: 10px;"><SPAN
									class=xstyle_69_10>年龄：</SPAN></TD>
								<TD class=xstyle_69_7 style="width: 10px;"><SPAN
									class=xstyle_69_8>${jyrxx.nl } </SPAN></TD>
								<TD class=xstyle_69_5 style="width: 10px;"><SPAN
									class=xstyle_69_6>总检日期：</SPAN></TD>
								<TD class=xstyle_69_7 style="width: 10px;"><SPAN
									class=xstyle_69_8>${jyrxx.zjrq } </SPAN></TD>
							</TR>
							<TR style="HEIGHT: 100px" style="width:10px;">
								<TD class=xstyle_69_5><SPAN class=xstyle_69_6>总检结果：</SPAN></TD>
								<TD  style="width: 1000px;"><SPAN
									class=xstyle_69_8>${jyrxx.zjjg } </SPAN></TD>
						...
						<COLGROUP>
							...
							<thead>
								<TR style="HEIGHT: 24px">
									<TD class=xstyle_69_13><SPAN class=xstyle_69_6>体检科室</SPAN></TD>
									<TD class=xstyle_69_13><SPAN class=xstyle_69_6>体检项目</SPAN></TD>
									<TD class=xstyle_69_13><SPAN class=xstyle_69_6>体检小结</SPAN>
									<TD class=xstyle_69_13><SPAN class=xstyle_69_6>体检结果</SPAN></TD>
									<TD class=xstyle_69_13><SPAN class=xstyle_69_6>体检结果单位</SPAN></TD>
							...
							<tbody>
								 <c:forEach items="${jyrxxList }" var="jyrxxList">
									<TR style="HEIGHT: 26px">
										<TD class=xstyle_69_5><SPAN class=xstyle_69_6>${jyrxxList.ksmc }
										</SPAN></TD>
										<TD class=xstyle_69_5><SPAN class=xstyle_69_6>${jyrxxList.xmmc }
										</SPAN></TD>
										<TD class=xstyle_69_5><SPAN class=xstyle_69_6>${jyrxxList.tjxj }
										</SPAN></TD>
										<TD class=xstyle_69_5><SPAN class=xstyle_69_6>${jyrxxList.xmjg }
										</SPAN></TD>
										<TD class=xstyle_69_5><SPAN class=xstyle_69_6>${jyrxxList.xmjgdw }
										</SPAN></TD>
										<TD class=xstyle_69_5><SPAN class=xstyle_69_6>${jyrxxList.xmjgckz }
										</SPAN></TD>
									</TR>
								 </c:forEach>
							</tbody>
