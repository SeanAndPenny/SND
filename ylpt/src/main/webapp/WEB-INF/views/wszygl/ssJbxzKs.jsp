...
function chart01(id,yljgdm,yljgmc,ssjb,ksbm,ksmc,month){
	...
	var option = {
	 ...
	 window.open("${ctx}/ssJbxzKsRy/ssJbxzKsRy?p_ssjb="+ssjb[0]+"&p_yljgdm="+yljgdm[param.dataIndex]
	 +"&p_ksbm="+ksbm[param.dataIndex]); 
	});
}

function getechatsdata(ssjb,yljgdm ){
	
    $.ajax({
    	url: "${ctx}/ssJbxzKs/ssJbxzKsecharts.json?p_ssjb="+ssjb+"&p_yljgdm="+yljgdm,
    	 datatype:"json",
    	...
    	success: function(data){
    		 ...
    		 var fianl=xx.ssJbxzKsechartsList;
    		 ...
    		 for (var i=0;i<fianl.length;i++)
		             ...
		             ssjb[i]=fianl[i].ssjb;	
		             ksbm[i]=fianl[i].sqksbm;	
		             ksmc[i]=fianl[i].sqks;	
		       		 month[i]=fianl[i].rs;
		         		 
		         	}
         	
         	chart01('map',yljgdm,yljgmc,ssjb,ksbm,ksmc,month);
    		}
      	});
