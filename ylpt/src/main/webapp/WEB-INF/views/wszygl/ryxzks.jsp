...
function chart01(id,ksdm,moth,values,jb,zc,jgdm,jgmc){
...
function getechatsdata(jb,zc,jgdm){
	
    $.ajax({
    	url: "${ctx}/ryxz/ryxzjksecharts.json?p_jb="+jb+"&p_zc="+zc+"&p_jgdm="+jgdm,
    	 datatype:"json",
    	...
    	success: function(data){
    		...
    		var hh= JSON.stringify(nodes);
    		 ...
    		 for (var i=0;i<fianl.length;i++)
		         	{   
    			        ksdm[i]=fianl[i].dept_code;
		         		month[i]=fianl[i].dept_name;
		         		zsum[i]=fianl[i].rs;
		         		jgmc[i]=fianl[i].org_name;
		         		jgdm[i]=fianl[i].org_code;
		         		
		         	}
         	
         	chart01('map',ksdm,month,zsum,jb,zc,jgdm,jgmc);
    		}
      	});
