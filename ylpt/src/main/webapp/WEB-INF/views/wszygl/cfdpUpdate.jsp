...
$(document).ready(function(){
	var rname = 'type';
	var rValue = '${cfdp.type}';
	initradio(rname,rValue)
});
</script>
<body style="background: #F9F9F9;overflow:scroll;">
	<form  id="form2">
		<label style="display:none;">医疗机构代码<input type="text" readonly="readonly" name="yljgdm" value="${cfdp.yljgdm }"></label>
		<label style="display:none;">id<input type="text" readonly="readonly" name="id" value="${cfdp.id }"></label>
		<div class="layui-inline">
		<label class="layui-form-label">用药分析：</label>
				<div class="layui-input-inline">
					<div class="layui-input-inline"><input type="text" id="cfdpnr" name="cfdpnr" value="${cfdp.cfdpnr }" class="layui-input">
					</div></div></div>
