...
function insertCzrk(){
	 if ($("#yljgdm").val() == '' || $("#yljgdm").val() == null) { 
		  window.open("${ctx}/gwgxyglbb/insertGxysl?p_yljgdm="+'${yljgdm}');
		  
		} else {
		window.open("${ctx}/gwgxyglbb/insertGxysl?p_yljgdm="+$("#yljgdm").val());
...
function toExcel() {
	 if ($("#yljgdm").val() == '' || $("#yljgdm").val() == null) { 
			location.href = "${ctx}/gwgxyglbb/toExcel?enddate="
...
function getData(yljgdm,enddate){
        layui.use(['table','layer','laydate'] , function(){
            ...
            table.render({
				...
				cols : [ [ 
					{ field : 'yljgmc', title : '管辖机构', width : '200' }, 
					{ field : 'glrs1', title : '年内辖区内已管理的高血压患者人数', width : '150' },
					{ field : 'glrs2', title : '按照规范要求进行高血压患者健康管理的人数（人）', width : '150' }, 
					{ field : 'bl1', title : '高血压患者规范管理率（%）', width : '150' }, 
					{ field : 'glrs3', title : '最近一次随访血压达标人数（人）', width : '170' },
					{ field : 'bl2', title : '管理人群血压控制率（%）', width : '170' }, 
					{ field : 'glrs4', title : '在管高血压患者家庭医生签约人数（人）', width : '170' },
					{ field : 'bl3', title : '在管高血压患者家庭医生签约率（%）', width : '150' }
			...
			<tr>
				...
				<td style="width: 25%">
					<div class="layui-form-item"
						...
						<div class="layui-input-block">
							<button class="layui-btn"  onclick="insertCzrk();">插入高血压患者人数</button>
						</div>
					</div>
				</td>
