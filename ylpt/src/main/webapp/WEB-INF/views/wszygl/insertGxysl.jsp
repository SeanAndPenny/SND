...
<html>
<head>
<title>年内辖区内已管理的高血压患者人数填写</title>
	...
	function toBc() {
		  ...
		  if($("#yljgdm").val() == '' || $("#yljgdm").val() == null){
			...
			layer.msg("数字格式错误或未填");
			  ...
			  $.ajax({
	        type:"get",
	        url:"${ctx}/gwgxyglbb/saveHt.json?yljgdm="+$("#yljgdm").val()+"&rksl="+$("#rksl").val()+"&enddate="+$("#enddate").val(),
	        dataType:'json',
			...
			<tr>
				...
				<td style="width: 33.3%">
					<div class="layui-form-item"
						...
						<label class="layui-form-label label3">高血压数量</label>
						<div class="layui-input-inline input3">
