...
//           });
            table.render({
                elem:'#querytable',
                url: '${ctx}/operation/showHospital',
                method:'post',
                where:{p_gradeid:gradeid,p_yljgdm:$("#yljgdm").val()},          
                cols: [[
                	{field: 'gradename', title: '手术名称', width: '200'},
                	{field: 'gopename', title: '手术操作名称', width: '200'},
                    {field: 'yljgmc', title: '机构名称', width: '120'}, 
                    {field: 'sqr', title: '申请人', width: '100'}, 
                    {field: 'sqsj', title: '申请时间', width: '120'}, 
...
<script type="text/html" id="toolbar">
	...
	<a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="del">否决</a>
</script>
</html>