...
function getData(){
	...
	yljg=$("#yljgdm").val();
        layui.use(['table','layer','laydate'] , function(){
            ...
            table.render({
                elem:'#querytable',
                url: '${ctx}/jkdaAppUser/queryList',
                method:'post',
                where:{p_idcard:$("#idcard").val()},          
                cols: [[
                    {field: 'id', title: 'id', width: '15%'},
                    {field: 'idcard', title: '证件号码', width: '20%'},
                    {field: 'tel', title: '注册电话', width: '20%'},
                    {field: 'flag', title: '是否启用', width: '15%'},
                    {field: 'removed', title: '是否删除',width: '30%'}
                     ]],
                height: '300',
                page: {
